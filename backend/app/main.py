...
# ==================== CORS CONFIGURATION ====================
# This MUST be before any routes are defined

# Allow all origins for now (you can restrict this later)
origins = [
    "https://voxsplit-frontend.onrender.com",
    "https://voxsplit-backend.onrender.com",
    "http://localhost:3000",
    "http://localhost:5173",
    "http://127.0.0.1:3000",
    "http://127.0.0.1:5173",
...
# Mount static files for serving audio (after directories are created)
try:
    settings.output_dir.mkdir(parents=True, exist_ok=True)
...
async def root():
    ...
    return {"status": "ok", "message": "VoxSplit API is running"}
